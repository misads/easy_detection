...
marking = pd.read_csv('/home/raid/public/datasets/wheat_detection/train.csv')
...
TRAIN_ROOT_PATH = '/home/raid/public/datasets/wheat_detection/train'
...
eff_train_loader = torch.utils.data.DataLoader(
    train_dataset,
    batch_size=8,
    shuffle=True,
