import sys
sys.path.insert(0, "/home/mist/zks/timm-efficientdet-pytorch")
sys.path.insert(0, "/home/mist/zks/omegaconf")
import pdb
import torch
import os
...
def get_net():
    ...
    checkpoint = torch.load('/home/mist/zks/efficientdet_d5-ef44aea8.pth')
