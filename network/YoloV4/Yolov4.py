...
from .tools.torch_utils import get_region_boxes
...
class Neck(nn.Module):
    ...
    def forward(self, input, downsample4, downsample3, inference=False):
        ...
        x7 = self.conv7(x6)
        # UP
        up = self.upsample1(x7, downsample4.size(), not self.training)
        # R 85
        ...
        # UP
        up = self.upsample2(x14, downsample3.size(), not self.training)
        # R 54
